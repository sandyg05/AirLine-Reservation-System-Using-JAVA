...
<!DOCTYPE html>
<html lang="en">
<% String pagename="contact_response_u.jsp"; session.setAttribute("pagename", pagename); %>
<head>
    <meta charset="utf-8">
                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0">
                                ...
                                <a href="contact_response_u.jsp" class="nav-item nav-link active">Contact</a>
                            </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h1 class="mb-5"><span class="text-primary text-uppercase">Previous</span> Response Submitted Successfully</h1>
                </div>
